...
public class Politics {
	...
	public static Politic[] mPolitics = {
		new Politic("Anarchy", 0, 0, 7, 1, 0, 5, 7, drugsOK, firearmsOK, GameState.FOOD),
		new Politic("Capitalist State", 2, 3, 2, 7, 4, 7, 1, drugsOK, firearmsOK, GameState.ORE),
		new Politic("Communist State", 6, 6, 4, 4, 1, 5, 5, drugsOK, firearmsOK, -1),
		new Politic("Confederacy", 5, 4, 3, 5, 1, 6, 3, drugsOK, firearmsOK, GameState.GAMES),
		new Politic("Corporate State", 2, 6, 2, 7, 4, 7, 2, drugsOK, firearmsOK, GameState.ROBOTS),
		new Politic("Cybernetic State", 0, 7, 7, 5, 6, 7, 0, drugsNotOK, firearmsNotOK, GameState.ORE),
		new Politic("Democracy", 4, 3, 2, 5, 3, 7, 2, drugsOK, firearmsOK, GameState.GAMES),
		new Politic("Dictatorship", 3, 4, 5, 3, 0, 7, 2, drugsOK, firearmsOK, -1),
		new Politic("Fascist State", 7, 7, 7, 1, 4, 7, 0, drugsNotOK, firearmsOK, GameState.MACHINERY),
		new Politic("Feudal State", 1, 1, 6, 2, 0, 3, 6, drugsOK, firearmsOK, GameState.FIREARMS),
		new Politic("Military State", 7, 7, 0, 6, 2, 7, 0, drugsNotOK, firearmsOK, GameState.ROBOTS),
		new Politic("Monarchy", 3, 4, 3, 4, 0, 5, 4, drugsOK, firearmsOK, GameState.MEDICINE),
		new Politic("Pacifist State", 7, 2, 1, 5, 0, 3, 1, drugsOK, firearmsNotOK, -1),
		new Politic("Socialist State", 4, 2, 5, 3, 0, 5, 6, drugsOK, firearmsOK, -1),
		new Politic("State of Satori", 0, 1, 1, 1, 0, 1, 0, drugsNotOK, firearmsNotOK, -1),
		new Politic("Technocracy", 1, 6, 3, 6, 4, 7, 2, drugsOK, firearmsOK, GameState.WATER),
		new Politic("Theocracy", 5, 6, 1, 4, 0, 4, 0, drugsOK, firearmsOK, GameState.NARCOTICS)
	};
