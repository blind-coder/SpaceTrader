...
public class Tradeitems {
	public static Tradeitem[] mTradeitems = {new Tradeitem("Water", 0, 0, 2, 30, +3, 4,
	                                                       ...
	                                                       GameState.DESERT, 30, 50, 1
	), new Tradeitem("Furs", 0, 0, 0, 250, +10, 10, GameState.COLD, GameState.RICHFAUNA,
	                 GameState.LIFELESS, 230, 280, 5
	), new Tradeitem("Food", 1, 0, 1, 100, +5, 5, GameState.CROPFAILURE, GameState.RICHSOIL,
	                 GameState.POORSOIL, 90, 160, 5
	), new Tradeitem("Ore", 2, 2, 3, 350, +20, 10, GameState.WAR, GameState.MINERALRICH,
	                 GameState.MINERALPOOR, 350, 420, 10
	), new Tradeitem("Games", 3, 1, 6, 250, -10, 5, GameState.BOREDOM, GameState.ARTISTIC, -1, 160,
	                 270, 5
	), new Tradeitem("Firearms", 3, 1, 5, 1250, -75, 100, GameState.WAR, GameState.WARLIKE, -1, 600,
	                 1100, 25
	), new Tradeitem("Medicine", 4, 1, 6, 650, -20, 10, GameState.PLAGUE, GameState.LOTSOFHERBS, -1,
	                 400, 700, 25
	), new Tradeitem("Machines", 4, 3, 5, 900, -30, 5, GameState.LACKOFWORKERS, -1, -1, 600, 800, 25),
	                                         new Tradeitem("Narcotics", 5, 0, 5, 3500, -125, 150,
	                                                       GameState.BOREDOM,
	                                                       GameState.WEIRDMUSHROOMS, -1, 2000, 3000,
	                                                       50
	                                         ), new Tradeitem("Robots", 6, 4, 7, 5000, -150, 100,
	                                                          GameState.LACKOFWORKERS, -1, -1, 3500,
	                                                          5000, 100
	)};
