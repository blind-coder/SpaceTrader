...
public class SpecialEvents {
	public static SpecialEvent[] mSpecialEvent = {new SpecialEvent("Dragonfly Destroyed",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Lightning Ship",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Monster Killed",
	                    ...
	                    -15000, 0, true
	), new SpecialEvent("Medicine Delivery",
	                    ...
	                    0, 0, false
	), new SpecialEvent("Moon For Sale",
	                    ...
	                    GameState.COSTMOON, 4, false
	), new SpecialEvent("Skill Increase",
	                    ...
	                    5000, 3, false
	), new SpecialEvent("Tribble Buyer",
	                    ...
	                    0, 3, false
	), new SpecialEvent("Space Monster",
	                    ...
	                    0, 1, true
	), new SpecialEvent("Cargo For Sale",
	                    ...
	                    0, 1, false
	), new SpecialEvent("Lottery Winner",
	                    ...
	                    -1000, 0, true
	), new SpecialEvent("Artifact Delivery",
	                    ...
	                    -20000, 0, true
	), new SpecialEvent("Alien Artifact",
	                    ...
	                    0, 1, false
	), new SpecialEvent("Ambassador Jarek",
	                    ...
	                    0, 1, false
	), new SpecialEvent("Alien Invasion",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Gemulon Invaded",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Jonathan Wild",
	                    ...
	                    0, 1, false
	), new SpecialEvent("Morgan's Reactor",
	                    ...
	                    0, 0, false
	), new SpecialEvent("Install Morgan's Laser",
	                    ...
	                    0, 0, false
	), new SpecialEvent("Scarab Stolen",
	                    ...
	                    0, 0, false
	), new SpecialEvent("Scarab Destroyed",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Reactor Delivered",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Jarek Gets Out",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Gemulon Rescued",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Disaster Averted",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Experiment Failed",
	                    ...
	                    0, 0, true
	), new SpecialEvent("Wild Gets Out",
